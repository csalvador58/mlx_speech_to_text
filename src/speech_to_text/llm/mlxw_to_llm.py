    ...
    def _validate_llm_connection(self) -> None:
        ...
        try:
            ...
            if LLM_MODEL not in available_models:
                logging.warning(f"Configured model '{LLM_MODEL}' not found in available models: {available_models}")
        ...
        try:
            ...
            for msg in messages:
                ...
                if not isinstance(msg['content'], str):
                    logging.error(f"Content must be string, got: {type(msg['content'])}")
                    return False
